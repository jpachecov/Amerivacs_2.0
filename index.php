      ...
      <div class="footer container nopadding">
         <div class='info_foot col-md-7 col-sm-6 col-xs-12'>
           ...
           <p class="col-md-12 col-sm-12 col-xs-12">
             ...
             <span style='width:49%; display:inline-block; margin:0%;'>  San Diego, CA 92154  </span>
         ...
         <div class='submenu col-md-5 col-xs-12 col-sm-6'>
           ...
           <span class='cursor hov4 col-md-3 col-xs-3 ' ng-mouseover='showFooter()'  ng-click='loadPage("products")'>PRODUCTS</span>
         ...
         <div class='col-md-5 col-sm-6 col-xs-12 dropdown-content'  ng-mouseover='showFooter()'
          ng-mouseleave='hideFooter()' >
